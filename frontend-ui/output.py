...
class OutputFields:
    ...
    def init_selectable_labels_widgets(self):
        ...
        self.wage_label: LBL = tbs.Label(self.yearly_labelframe, text=currency_string(1002.25, self.currency_symbol), width=15, anchor="center")
        self.pension_label: LBL = tbs.Label(self.yearly_labelframe, text=currency_string(1002.25, self.currency_symbol), width=15, anchor="center")
        self.rent_label: LBL = tbs.Label(self.yearly_labelframe, text=currency_string(1002.25, self.currency_symbol), width=15, anchor="center")


    def place_selectable_labels_widgets(self, grid_row: int, grid_column: int, grid_margin_xy: float, widget_margin_xy: float):
        ...
        self.wage_label.grid(row=0, column=0, padx=widget_margin_xy)
        self.pension_label.grid(row=0, column=2, padx=widget_margin_xy)
        self.rent_label.grid(row=0, column=4, padx=widget_margin_xy)
